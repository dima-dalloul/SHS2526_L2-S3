...
public class TestCoordonnee {
    ...
    public void testConstructeurString() {
        ...
        // vérifie que B4 est bien (3,1)
        b4 = new Coordonnee("B4");
        assertEquals(3, b4.getLigne());
        assertEquals(1, b4.getColonne());

        // vérifie que b4 est bien (3,1) malgré que b est minuscule
        b4 = new Coordonnee("b4");
        assertEquals(3, b4.getLigne());
        assertEquals(1, b4.getColonne());

        // vérifie que A10 est bien (9,0)
    ...
    public void testToString() {
        ...
        b4 = new Coordonnee("B4");
        a10 = new Coordonnee("A10");
        // Je rajoute un cas de test
        Coordonnee d6 = new Coordonnee("d6");
